...
/**
 * Helper methods related to requesting and receiving earthquake Earthquake from USGS.
 */
public final class QueryUtils {
    ...
    private static List<Earthquake> extractFeatureFromJson(String earthquakeJSON) {
        ...
        try {
            ...
            // build up a list of Earthquake objects with the corresponding Earthquake.
